...
/**
 * SnapshotProfileInstance
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\SnapshotProfileInstanceRepository")
 */
class SnapshotProfileInstance
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Instance", mappedBy="snapshopProfileInstance", cascade={"remove", "persist"})
     */
    private $instances;
     ...
     * @return SnapshotProfileInstance
     */
